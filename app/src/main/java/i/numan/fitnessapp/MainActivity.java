...
import i.numan.fitnessapp.DAO.CVSManager;
import i.numan.fitnessapp.DAO.DAOCardio;
import i.numan.fitnessapp.DAO.DAOFonte;
import i.numan.fitnessapp.DAO.DAOMachine;
import i.numan.fitnessapp.DAO.DAOProfil;
import i.numan.fitnessapp.DAO.DatabaseHelper;
import i.numan.fitnessapp.DAO.Fonte;
import i.numan.fitnessapp.DAO.Machine;
import i.numan.fitnessapp.DAO.Profile;
import i.numan.fitnessapp.DAO.cardio.DAOOldCardio;
import i.numan.fitnessapp.DAO.cardio.OldCardio;
import i.numan.fitnessapp.bodymeasures.BodyPartListFragment;
import i.numan.fitnessapp.fonte.FontesPagerFragment;
import i.numan.fitnessapp.intro.MainIntroActivity;
import i.numan.fitnessapp.machines.MachineFragment;
import i.numan.fitnessapp.utils.CustomExceptionHandler;
import i.numan.fitnessapp.utils.ImageUtil;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        File folder = new File(Environment.getExternalStorageDirectory() + "/Fitness");
        boolean success = true;
        if (!folder.exists()) {
            success = folder.mkdir();
        }
        if (success) {
            folder = new File(Environment.getExternalStorageDirectory() + "/Fitness/crashreport");
            success = folder.mkdir();
        }
        ...
        if (folder.exists()) {
            if (!(Thread.getDefaultUncaughtExceptionHandler() instanceof CustomExceptionHandler)) {
                Thread.setDefaultUncaughtExceptionHandler(new CustomExceptionHandler(
                        Environment.getExternalStorageDirectory() + "/Fitness/crashreport"));
            }
        }
