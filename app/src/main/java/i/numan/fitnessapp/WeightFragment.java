...
import i.numan.fitnessapp.DAO.DAOWeight;
import i.numan.fitnessapp.DAO.Profile;
import i.numan.fitnessapp.DAO.bodymeasures.BodyMeasure;
import i.numan.fitnessapp.DAO.bodymeasures.BodyPart;
import i.numan.fitnessapp.DAO.bodymeasures.DAOBodyMeasure;
import i.numan.fitnessapp.bodymeasures.BodyPartDetailsFragment;
import i.numan.fitnessapp.utils.EditableInputView.EditableInputView;
import i.numan.fitnessapp.utils.EditableInputView.EditableInputViewWithDate;
import i.numan.fitnessapp.utils.Gender;
...
public class WeightFragment extends Fragment {
    ...
    private OnClickListener showDetailsFragment = v -> {
        ...
        if (fragmentView != null) {
            if (getProfil() != null) {
                ...
                if (lastWaterValue != null)
                    waterEdit.setText(String.valueOf(((BodyMeasure) lastWaterValue).getBodyMeasure()));
                else
                    waterEdit.setText("-");
