...
import i.numan.fitnessapp.utils.AlarmReceiver;
...
public class CountdownDialogbox extends Dialog implements
    ...
    private Chronometer.OnChronometerTickListener onChronometerTick = new Chronometer.OnChronometerTickListener() {
